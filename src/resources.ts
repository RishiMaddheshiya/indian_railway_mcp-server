...
export function registerResources(server: McpServer, provider: RailProvider): void {
  server.registerResource(
    ...
    'irctc://stations',
    {
      ...
      description:
        'Bundled directory of major Indian Railways stations with codes, states and zones.',
  ...
  server.registerResource(
    ...
    'irctc://trains',
    {
      ...
      description:
        'Bundled sample of popular trains with route, classes and days of operation.',
      mimeType: 'application/json',
    },
    async (uri) => ({
      contents: [
  ...
  server.registerResource(
    'train',
    new ResourceTemplate('irctc://train/{trainNumber}', { list: undefined }),
    {
